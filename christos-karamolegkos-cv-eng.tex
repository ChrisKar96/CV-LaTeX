...
\begin{document}
	...
	\textbf{DevOps}	                & Ansible, Git, Github, Github Actions, GitLab, CI/CD, Docker, Podman, Kubernetes \\
	...
	\textbf{Leadership}				& Team Leadership, Management, Technical Leading, Mentoring \\
	\textbf{Languages} 			   	& Greek (Native), English (Business Fluent)
	\end{tabular}

	\section{Experience}

	\begin{EntryDatedLogo}{Power Factors}{https://powerfactors.com}{November 2024 -- Now}{Manager, Systems \& Infrastructure}{assets/powerfactors.png}{0.75}
		\begin{Itemize}
			\item Managed a team of 9+ engineers, in a team focused on Systems \& Infrastructure.
			\item Onboarded and mentored team members and acted as technical lead for the team.
			\item Architectured robust solutions for both physical and virtual device deployment and spearheaded their implementation. 
			\item Automated the cybersecurity hardening of field devices according to CIS benchmarks.
		\end{Itemize}
		\vspace{-0.3cm}
		Relevant Skills: \textit{Leadership}, \textit{Management}, \textit{Linux}, \textit{Bash}, \textit{Ansible}, \textit{Cybersecurity}, \textit{Monitoring}, \textit{Kubernetes}
	\end{EntryDatedLogo}
	
	\vspace{0.5cm}

	\begin{EntryDatedLogo}{Power Factors}{https://powerfactors.com}{January 2024 -- November 2024}{Senior ITSM Engineer}{assets/powerfactors.png}{0.75}
		\begin{Itemize}
			\item Automated and performed deployment and maintenance across a fleet of more than 12000 servers and devices around the globe.
		...
		\end{Itemize}
		\vspace{-0.3cm}
		Relevant Skills: \textit{Linux}, \textit{Bash}, \textit{Ansible}, \textit{VPN}, \textit{Monitoring}, \textit{Kafka}, \textit{MQTT}, \textit{Cassandra}, \textit{Docker}, \textit{Kubernetes}
	\end{EntryDatedLogo}
	...
	\begin{EntryDatedLogo}{Hellenic Army}{http://army.gr}{March 2023 -- December 2023}{Mandatory Military Service}{assets/hellenicarmy.png}{0.75}
		\begin{Itemize}
			\item Modernized a cryptographically-secure mobile communications platform between more than 650 remote mobile devices across Greece.
		...
		\end{Itemize}
		\vspace{-0.3cm}
		Relevant Skills: \textit{Linux}, \textit{VPN}, \textit{SIP}, \textit{Monitoring}, \textit{High Availability}, \textit{Python / Django}, \textit{Docker}, \textit{Android}
	\end{EntryDatedLogo}
	...
	\begin{EntryDatedLogo}{Hilon Informatics Systems}{https://web.archive.org/web/20220522083934/http://www.hilonsys.com/}{May 2022 -- March 2023}{DevOps Engineer}{assets/hilonsys.png}{0.75}
		...
		\end{Itemize}
		\vspace{-0.3cm}
		Relevant Skills: \textit{Linux}, \textit{Ansible}, \textit{VPN}, \textit{Bash}, \textit{PKI}, \textit{LDAP}, \textit{Docker}, \textit{Kubernetes}
	\end{EntryDatedLogo}
	...
	\begin{EntryDatedLogo}{GFOSS - OPEN TECHNOLOGIES ALLIANCE}{https://gfoss.eu}{July 2019 -- March 2023}{Systems Administrator}{assets/eellak.png}{0.75}
		...
		\end{Itemize}
		\vspace{-0.3cm}
		Relevant Skills: \textit{Linux}, \textit{Ansible}, \textit{LEMP Stack}, \textit{VPN}, \textit{Bash}, \textit{LDAP}, \textit{PKI}, \textit{Docker}, \textit{Monitoring}
	\end{EntryDatedLogo}

	\section{Education}
    \begin{EntryDatedLogo}{Mini MBA}{}{December 2025 -- Now}{University of Patras}{assets/University_of_Patras_(seal).png}{0.8}
		\begin{Itemize}
			\item Basic concepts and methodologies for Business Administration.
		\end{Itemize}
	\end{EntryDatedLogo}
    ...
    \begin{EntryDatedLogo}{Certified Kubernetes Application Developer (CKAD)}{https://www.credly.com/users/christos-karamolegkos/badges}{December 2025}{Linux Foundation}{assets/ckad.png}{0.8}
		\begin{Itemize}
			\item Earners of this designation demonstrated the skills, knowledge and competencies to perform the responsibilities of a Kubernetes Application Developer.
		\end{Itemize}
	\end{EntryDatedLogo}

	\vspace{0.5cm}
    
    \begin{EntryDatedLogo}{Kubernetes and Cloud Native Security Associate (KCSA)}{https://www.credly.com/users/christos-karamolegkos/badges}{August 2025}{Linux Foundation}{assets/kcsa.png}{0.8}
		\begin{Itemize}
			\item Earners of this badge have demonstrated an understanding of the baseline security configuration of Kubernetes clusters to meet compliance objectives, including the ability to harden security controls, test and monitor the security, and participate in assessing security threats and vulnerabilities.
		\end{Itemize}
	\end{EntryDatedLogo}

	\vspace{0.5cm}

    \begin{EntryDatedLogo}{Kubernetes and Cloud Native Associate (KCNA)}{https://www.credly.com/users/christos-karamolegkos/badges}{July 2025}{Linux Foundation}{assets/kcna.png}{0.8}
		\begin{Itemize}
			\item Earners of this designation demonstrated a basic knowledge of Kubernetes and cloud-native technologies, including how to deploy an application using basic kubectl commands, the architecture of Kubernetes (containers, pods, nodes, clusters), understanding the cloud-native landscape and projects (storage, networking, GitOps, service mesh), and understanding the principles of cloud-native security.
		\end{Itemize}
	\end{EntryDatedLogo}

	\vspace{0.5cm}

    \begin{EntryDatedLogo}{GitHub Advanced Security}{https://www.credly.com/users/christos-karamolegkos/badges}{June 2025}{GitHub}{assets/github-advanced-security.png}{0.8}
		\begin{Itemize}
			\item Configure and use secret scanning, dependency management, and CodeQL code scanning.
			\item Describe GitHub Advanced Security best practices, results, and how to take corrective measures.
			\item Configure GitHub Advanced Security tools in GitHub Enterprise.
		\end{Itemize}
	\end{EntryDatedLogo}

	\vspace{0.5cm}

    \begin{EntryDatedLogo}{Linux Foundation Certified Engineer (LFCE)}{https://www.credly.com/users/christos-karamolegkos/badges}{March 2022}{Linux Foundation}{assets/LFCE.png}{0.8}
		\begin{Itemize}
    ...
    \begin{EntryDatedLogo}{GitLab Certified Associate}{https://about.gitlab.com/services/education/gitlab-certified-associate/}{July 2021}{GitLab}{assets/GitLab-Certified-Associate-2021-07-09.png}{0.8}
		\begin{Itemize}
