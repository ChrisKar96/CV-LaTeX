...
\begin{document}
	...
	\begin{tabular}{m{4.5cm} m{12.5cm}}
		...
		\textbf{Systems Administration}	& Apache2/nginx, PKI, SSH, Email, LDAP, OpenVPN, VMware/Virtualbox, Ansible \\
	...
	\begin{EntryDatedLogo}{University of Western Macedonia}{https://ece.uowm.gr/?lan=en}{October 2014 -- Present}{Department of Electrical and Computer Engineering}{0cm}{assets/uowm-logo.png}{0.8}
		\vspace{-0.2cm}
		\begin{Itemize}
