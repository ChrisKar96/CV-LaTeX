...
\begin{document}
	...
	\begin{EntryDatedLogo}{Power Factors}{https://powerfactors.com}{January 2024 -- November 2024}{Senior ITSM Engineer}{assets/powerfactors.png}{0.35}
		\begin{Itemize}
	...
	\begin{EntryDatedLogo}{Hellenic Army}{http://army.gr}{March 2023 -- December 2023}{Mandatory Military Service}{assets/hellenicarmy.png}{0.45}
		\begin{Itemize}
	...
	\begin{EntryDatedLogo}{Hilon Informatics Systems}{https://web.archive.org/web/20220522083934/http://www.hilonsys.com/}{May 2022 -- March 2023}{DevOps Engineer}{assets/hilonsys.png}{0.45}
		\begin{Itemize}
	...
	\begin{EntryDatedLogo}{GFOSS - OPEN TECHNOLOGIES ALLIANCE}{https://gfoss.eu}{July 2019 -- March 2023}{Systems Administrator}{assets/eellak.png}{0.45}
		\begin{Itemize}
	...
	\begin{EntryDatedLogo}{MEng in Computer and Telecommunications Engineering}{https://ece.uowm.gr/?lan=en}{October 2014 -- October 2023}{Department of Electrical and Computer Engineering, University of Western Macedonia}{assets/uowm-logo.png}{0.5}
		\begin{Itemize}
   ...
   \end{Itemize}
    ...
    \begin{EntryDatedLogo}{Kubernetes and Cloud Native Security Associate (KCSA)}{https://www.credly.com/users/christos-karamolegkos/badges}{August 2025}{Linux Foundation}{assets/kcsa.png}{0.6}
		\begin{Itemize}
    ...
    \begin{EntryDatedLogo}{Kubernetes and Cloud Native Associate (KCNA)}{https://www.credly.com/users/christos-karamolegkos/badges}{July 2025}{Linux Foundation}{assets/kcna.png}{0.6}
		\begin{Itemize}
    ...
    \begin{EntryDatedLogo}{GitHub Advanced Security}{https://www.credly.com/users/christos-karamolegkos/badges}{June 2025}{GitHub}{assets/github-advanced-security.png}{0.6}
		\begin{Itemize}
			\item Configure and use secret scanning, dependency management, and code scanning.
			\item Use code scanning with CodeQL.
    ...
    \begin{EntryDatedLogo}{Linux Foundation Certified Engineer (LFCE)}{https://www.credly.com/users/christos-karamolegkos/badges}{March 2022}{Linux Foundation}{assets/LFCE.png}{0.6}
		\begin{Itemize}
    ...
    \begin{EntryDatedLogo}{GitLab Certified Associate}{https://about.gitlab.com/services/education/gitlab-certified-associate/}{July 2021}{GitLab}{assets/GitLab-Certified-Associate-2021-07-09.png}{0.6}
		\begin{Itemize}
	...
	\begin{EntryDatedLogo}{WSO2 Certified Identity Server Developer - V5}{https://wso2.com/training/certification/certified-identity-server-developer}{June 2020}{WSO2}{assets/wso2is-cert.pdf}{0.6}
		\begin{Itemize}
	...
	\begin{EntryDatedLogo}{Centre of Social Welfare, Region of Central Macedonia}{http://www.kkp-km.gr/}{April 2018 -- December 2019}{Software Developer}{assets/kkpkm.pdf}{0.45}
		\begin{Itemize}
