...
\begin{document}
  ...
  \item \textit{Relevant Skills}: \textbf{Linux}, \textbf{VPN}, \textbf{SIP}, \textbf{Monitoring}, \textbf{High Availability}, \textbf{Python / Django}, \textbf{Docker}
   ...
   \item Restructured the organizations infrastructure from the ground up, installing VPN-only accessible, dockerized services like OpenVPN server, NTP, internal/external DNS server, GitLab, ansible controller and more.
...
\href{https://kubespray.io/}{\textit{kubespray}}.
   \item \textit{Relevant Skills}: \textbf{Linux}, \textbf{Ansible}, \textbf{VPN}, \textbf{Bash}, \textbf{PKI}, \textbf{LDAP}, \textbf{Docker}, \textbf{Kubernetes} 
    ...
    \item \textit{Relevant Skills}: \textbf{Linux}, \textbf{Ansible}, \textbf{LEMP Stack}, \textbf{VPN}, \textbf{Bash}, \textbf{LDAP}, \textbf{PKI}, \textbf{Docker}
  \end{Itemize}
	\end{EntryDatedLogo}
