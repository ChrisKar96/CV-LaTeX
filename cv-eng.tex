...
\begin{document}
	...
	\begin{EntryDatedLogo}{GFOSS - OPEN TECHNOLOGIES ALLIANCE}{https://gfoss.eu}{July 2019 -- Present}{Systems Administrator}{-0.3cm}{assets/eellak.png}{0.75}
		\begin{Itemize}
			...
			\item Infrastructure consists of 100+ on-premise or cloud VMs, mainly running \href{https://www.debian.org/}{\textit{Debian}} OS, managed using the \href{https://debops.org}{\textit{DebOps}} ansible project.
	...
	\begin{EntryDated}{Freelancer}{https://www.christoskaramo.tk}{2018 -- Present}{Programmer}{-1cm}
	\begin{Itemize}
	...
	\begin{EntryDatedLogo}{University of Western Macedonia}{https://ece.uowm.gr/?lan=en}{2014 -- Present}{Department of Electrical and Computer Engineering}{-0.3cm}{assets/uowm.pdf}{0.6}
	\begin{Itemize}
    ...
    \begin{EntryDatedLogo}{GitLab Certified Associate}{https://about.gitlab.com/services/education/gitlab-certified-associate/}{July 2021 -- Present}{GitLab Associate}{-0.3cm}{assets/GitLab-Certified-Associate-2021-07-09.png}{0.90}
		\begin{Itemize}
	...
	\begin{EntryDatedLogo}{WSO2 Certified Identity Server Developer - V5}{https://wso2.com/training/certification/certified-identity-server-developer}{June 2020 -- Present}{WSO2 Identity Server Developer}{-0.3cm}{assets/wso2is-cert.pdf}{0.90}
		\begin{Itemize}
