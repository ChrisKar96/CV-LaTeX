...
\begin{document}
	...
	\textnormal Είμαι επίδοξος Μηχανικός DevOps και Διαχειριστής Πληροφοριακών Συστημάτων, τελειόφοιτος του \href{https://ece.uowm.gr/?lan=gr}{\textit{τμήματος Ηλεκτρολόγων Μηχανικών και Μηχανικών Υπολογιστών του Πανεπιστημίου Δυτικής Μακεδονίας}}. Από νεαρή ηλικία ανακάλυψα το πάθος μου για την επίλυση προβλημάτων και τον σχεδιασμό λύσεων. Είμαι εργατικός, πρόθυμος να μάθω νέα πράγματα και να επεκτείνω τις δυνατότητές μου καθημερινά, χρησιμοποιώντας πάντα τα πιο ενημερωμένα εργαλεία και πληροφορίες που μου παρέχονται. Είμαι επίσης πολύ δραστήριος και μπορώ να αποδίδω καλά υπό πίεση.
